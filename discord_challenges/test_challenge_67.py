"""
How to use?
Import your solution in line 84, and run this script
If you see some weird chars instead of colors in output or don't want colors
switch COLOR_OUT to False in line 22
...
def test_challenge_67(input: Callable) -> None:
    ...
    with Capturing() as output:
        ...
        import ch7  # change this to your file name with solution without .py extension
